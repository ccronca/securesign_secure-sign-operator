...
func Test_SignerHandle(t *testing.T) {
	...
	tests := []struct {
		...
		testCase func(action.Action[*rhtasv1alpha1.TimestampAuthority], client.WithWatch, *rhtasv1alpha1.TimestampAuthority) bool
	}{
		{
			...
			testCase: func(_ action.Action[*rhtasv1alpha1.TimestampAuthority], client client.WithWatch, instance *rhtasv1alpha1.TimestampAuthority) bool {
		...
		},
		{
			...
			testCase: func(a action.Action[*rhtasv1alpha1.TimestampAuthority], client client.WithWatch, instance *rhtasv1alpha1.TimestampAuthority) bool {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			g.Expect(tt.testCase(action, client, instance)).To(BeTrue())
		})
	}
}
